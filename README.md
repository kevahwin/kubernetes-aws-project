...
```bash
helm repo add <REPO_NAME> oci://registry-1.docker.io/bitnamicharts
```
...
Alternatively you can combine steps 1 & 2 as such:
```bash
helm install <SERVICE_NAME> oci://registry-1.docker.io/bitnamicharts/postgresql
```
